...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2020 at 07:10 AM
...
INSERT INTO `agen_elpiji` (`id`, `nama_kota`, `nama`, `alamat`, `whatsapp`, `bank`, `ac`) VALUES
...
INSERT INTO `agen_galon` (`id`, `nama_kota`, `nama`, `alamat`, `whatsapp`, `bank`, `ac`) VALUES
(1, '3', 'asfa', 'AS', '087564784758', 'BCA', '098747298748374'),
(2, '1106', 'arrrrrr', 'jatilawang', '08762726262', 'Bank Jateng', '765273');
...
CREATE TABLE `daftar` (
  ...
  `daftar_sebagai` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `agen_galon`
  ADD PRIMARY KEY (`id`),
  ADD KEY `foreign_kota` (`nama_kota`);
